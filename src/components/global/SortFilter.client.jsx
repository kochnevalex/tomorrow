...
import {Heading, IconCaret, Text} from '~/components';
...
export function SortFilter({
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full p-6 py-6 md:px-8 lg:px-12">
        <button
      ...
      <div className="flex flex-col flex-wrap md:flex-row">
        <div
          className={`transition-all duration-200 w-full p-6 py-6 md:px-8 lg:px-12 ${
            isOpen ? 'block' : 'hidden'
          }`}
        >
          <FiltersDrawer
